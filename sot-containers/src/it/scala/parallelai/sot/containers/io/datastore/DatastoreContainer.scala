...
/**
  ...
  * @param projectId String ID of the project assigned to this datastore
...
class DatastoreContainer(val imageName: String = "google/cloud-sdk:latest",
  ...
  implicit val container: GenericContainer[_] = {
    ...
    container.setCommand(s"gcloud beta emulators datastore start --project=$projectId --host-port=0.0.0.0:$exposedPort")
