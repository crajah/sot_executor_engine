...
object Runner1 extends Poly1 with Serializable {
  implicit def runner[TAPIN, CONF, AIN, IN <: AIN, INREPR <: HList, AOUT, OUT <: AOUT, TAPOUT](implicit runner: Runner[TAPIN, CONF, AIN, IN, INREPR, AOUT, OUT, TAPOUT]) = at[RunnerConfig[TAPIN, CONF, AIN, IN, AOUT, OUT, TAPOUT]] {
    case config =>
...
trait Runner[TAPIN, CONF, AIN, IN <: AIN, INREPR <: HList, AOUT, OUT <: AOUT, TAPOUT] {
...
object Runner {
  def apply[TAPIN, CONF, AIN, IN <: AIN, INREPR <: HList, AOUT, OUT <: AOUT, TAPOUT](implicit runner: Runner[TAPIN, CONF, AIN, IN, INREPR, AOUT, OUT, TAPOUT]): Runner[TAPIN, CONF, AIN, IN, INREPR, AOUT, OUT, TAPOUT] = runner

  implicit def genericRunner[TAPIN, CONF, AIN, IN <: AIN, INREPR <: HList, AOUT, OUT <: AOUT, OUTREPR <: HList, TAPOUT](implicit
                                                                                     reader: Reader.Aux[TAPIN, CONF, AIN, IN, INREPR],
                                                                                     labelledGeneric: LabelledGeneric.Aux[OUT, OUTREPR],
                                                                                     transformer: Transformer.Aux[INREPR, OUTREPR],
                                                                                     writer: Writer[TAPOUT, CONF, AOUT, OUT, OUTREPR]): Runner[TAPIN, CONF, AIN, IN, INREPR, AOUT, OUT, TAPOUT] = new Runner[TAPIN, CONF, AIN, IN, INREPR, AOUT, OUT, TAPOUT] {
    def exec(in: SchemaType.Aux[AIN, IN], out: SchemaType.Aux[AOUT, OUT])(sc: ScioContext, tapIn: TapDefinition, tapOut: TapDefinition, config: CONF): Unit = {
