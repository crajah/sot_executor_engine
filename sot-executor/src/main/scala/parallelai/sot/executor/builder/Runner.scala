...
object Runner {
  def apply[TAPIN, CONF, AIN, IN <: AIN, AOUT, OUT <: AOUT, TAPOUT](implicit runner: Runner[TAPIN, CONF, AIN, IN, AOUT, OUT, TAPOUT]): Runner[TAPIN, CONF, AIN, IN, AOUT, OUT, TAPOUT] = runner

  implicit def genericRunner[TAPIN, CONF, AIN, IN <: AIN, AOUT, OUT <: AOUT, TAPOUT](
